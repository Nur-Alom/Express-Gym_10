...
const Register = () => {
    const { googleLogin, githubLogin, handleName, handleEmail, handlePassword, handleRegister, users } = useAuth();
    console.log(users);
    return (
        <div className="container main">
            <div className="form">
                <div className="data-field">
                    ...
                    <input onBlur={handleName} className="input-register rounded-pill" type="name" name="name" id="1" placeholder="Your Name" required />
                    <input onBlur={handleEmail} className="input-register rounded-pill" type="email" name="email" id="2" placeholder="Your Email" required />
                    <input onBlur={handlePassword} className="input-register rounded-pill" type="password" name="password" id="3" placeholder="Your Password" required />
